...
- Clone o projeto
  ...
  ```bash
  git clone git@github.com:FIAP-SOAT-G19/payments-microsservice.git
  ````
---
...
![Arquitetura do Projeto](./assets/images/unit-test-payments.png)

- Evidência teste BDD
![Arquitetura do Projeto](./assets/images/bdd-payments_.png)
  ```bash
  npm run test:bdd
  ```
---
...
- Utilize os comandos abaixo para encaminhar as conexões das portas locais para a portas dos pod's Kubernetes (o segundo comando é opcional)
  ```bash
    kubectl port-forward service/api-svc 3002:3002 &
    kubectl port-forward service/database-svc 5432:5432 &
  ```

- O Backend iniciará em [http://localhost:3002](http://localhost:3002)
